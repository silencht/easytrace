...
{ 
  ...
  GPIO_Init(GPIOG, &GPIO_InitStructure);//初始化
 	...
 	OV2640_PWDN=0;	//POWER ON PG9=0
	delay_ms(10);
	OV2640_RST=0;	//复位OV2640  PG15=0
	delay_ms(10);
	OV2640_RST=1;	//结束复位   PG15=1
  SCCB_Init();        		//初始化SCCB 的IO口	 
	...
	if(reg!=OV2640_PID)
	{
 	...
 	//初始化序列 OV2640,ov2640_sxga_init_reg_tbl采用SXGA分辨率(1600*1200)    ov2640_svga_init_reg_tbl
...
//设置图像开窗大小
//由:OV2640_ImageSize_Set 确定传感器输出分辨率从大小.
